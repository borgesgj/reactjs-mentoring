...
class MovieListContainer extends React.Component {
    ...
    componentDidMount() {
        console.log("API Call for fetching movies will be made here");
    ...
    render() {
        return (
            <div className="movie-list-container clearfix">
                <TabControl tabItems={this.tabItems} enabledTab={1}>
                ...
                <MovieCount movieCount={this.state.movies.length}/>
                <MovieList movieList={this.state.movies} onActionClick={(data) => props.onActionClick(data)}/>
            </div>
        );
    }
}
